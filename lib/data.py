...
def fetch_HAR(path):
    ...
    X_train_path = os.path.join(path, 'train', 'X_train.txt')
    y_train_path = os.path.join(path, 'train', 'y_train.txt')
    X_test_path = os.path.join(path, 'test', 'X_test.txt')
...
def fetch_UNIMIB(path):
    ...
    val_path   = os.path.join(path, 'unimib_val.csv')
    test_path  = os.path.join(path, 'unimib_test.csv')
    ...
    print("Train samples(Raw):", len(train_df))
    print("Validation samples(Raw):", len(val_df))
    print("Test samples(Raw):", len(test_df))
